!(function (t, e) {
  ...
  class Q extends m {
    ...
    getVisibleSlides(t = 0) {
      ...
      if (o) {
        ...
        let l = 0;
        ((l =
          n && n.state !== b.Init && n.state !== b.Destroy
  ...
  const lt = () => {
    queueMicrotask(() => {
      (() => {
        const { slug: t, index: e } = ct.parseURL(),
          i = be.getInstance();
  ...
  class ct extends _ {
    ...
    onClose() {
      if ((this.timer && clearTimeout(this.timer), !0 !== ct.hasSilentClose))
        try {
    ...
    static startFromUrl() {
      if (
        ((ct.hasSilentClose = !1), be.getInstance() || !1 === be.defaults.Hash)
      )
        return;
      const { hash: t, slug: e, index: i } = ct.parseURL();
      if (!e) return;
  ...
  class ut extends _ {
    ...
    onClose() {
      ...
      if (!l) return;
      ((this.instance.state = at.CustomClosing),
    ...
    getZoomInfo(t) {
      ...
      ((f += m.left), (u += m.top));
      const b = -1 * (f + 0.5 * p - (c + 0.5 * h)),
        v = -1 * (u + 0.5 * g - (l + 0.5 * d)),
        y = h / p;
      let w = this.option("zoomOpacity") || !1;
      return (
        "auto" === w && (w = Math.abs(h / d - p / g) > 0.1),
        { x: b, y: v, scale: y, opacity: w }
      );
    }
    attach() {
      const t = this,
  ...
  class Et extends _ {
    ...
    onUnselectSlide(t, e, i) {
      ...
      (i.type === bt
        ...
        : i.type === mt && (o = { event: "command", func: "pauseVideo" }),
        o &&
          i.iframeEl &&
    ...
    processType(t) {
      ...
      (i ||
        ...
        (t.type = i),
        i === pt && (t.thumbSrc = t.thumbSrc || t.src));
    }
    setContent(t) {
      const e = this.instance.optionFor(t, "src") || "";
      if (t && t.type && e) {
  ...
  let It = class extends _ {
    ...
    onInitSlide(t, e) {
      ...
      (i &&
        ...
        (e[kt] = parseFloat(i[kt] || "") || e[kt] || 0),
        (e[Rt] = parseFloat(i.thumbHeight || "") || e[Rt] || 0)),
        this.addSlide(e));
    }
    onInitSlides() {
      this.build();
    ...
    resizeModernSlide(t) {
      this.isModern &&
        (t[zt] =
          t[kt] && t[Rt] ? Math.round(this[Rt] * (t[kt] / t[Rt])) : this[zt]);
    }
    updateProps() {
      const t = this.container;
      if (!t) return;
  ...
  class Ht extends _ {
    ...
    onInit() {
      ...
      ((o.Carousel = o.Carousel || {}),
        ...
        (n.options.Thumbs = o),
        n.attachPlugins({ Thumbs: It }),
        (e.ref = n.plugins.Thumbs),
        e.option("showOnStart") ||
          ((e.ref.state = At.Hidden), (e.hidden = !0)));
    }
    onResize() {
      var t;
    ...
    toggle() {
      const t = this.ref;
      if (t && !t.isDisabled())
        return t.state === At.Hidden
          ? ((t.state = At.Init), void t.build())
    ...
    attach() {
      const t = this,
        e = t.instance;
      (e.state === at.Init ? e.on("Carousel.init", t.onInit) : t.onInit(),
  ...
  class qt extends _ {
    ...
    createContainer() {
      ...
      return (
        i || ((i = document.createElement("div")), C(i, Xt), e.prepend(i)),
  ...
  class be extends m {
      ...
      ((this.state = at.Init),
        ...
        !0 === this.option("hideScrollbar") &&
          (() => {
            ...
            (n < 0 && (n = 0),
              i.style.setProperty(Ut, `${n}px`),
              s && e.style.setProperty(Gt, `${s}px`),
              e.classList.add(Zt));
          })(),
        this.initLayout(),
        this.scale());
    ...
    initLayout() {
      ...
      n &&
        ...
        n.classList.toggle(te, this.isCompact),
        C(n, this.option("mainClass") || ""),
        C(n, ie),
        (this.container = n),
        (this.footer = n.querySelector(".fancybox__footer")),
        i.appendChild(n),
        C(document.documentElement, Vt),
        (de && ue) ||
          ((de = document.createElement("span")),
          C(de, "fancybox-focus-guard"),
          de.setAttribute(oe, "0"),
          de.setAttribute(Kt, "true"),
          de.setAttribute("aria-label", "Focus guard"),
          (ue = de.cloneNode()),
          null === (t = n.parentElement) ||
            void 0 === t ||
            t.insertBefore(de, n),
          null === (e = n.parentElement) || void 0 === e || e.append(ue)),
          ...
          if (!t.isInfinite) {
            for (const i of e.querySelectorAll("[data-fancybox-next]"))
              t.page < t.pages.length - 1
                ? (i.removeAttribute(se), i.removeAttribute(oe))
                : (i.setAttribute(se, ""), i.setAttribute(oe, "-1"));
          ...
          for (const t of e.querySelectorAll("[data-fancybox-download]")) {
            ...
            n
              ? (t.removeAttribute(se),
                t.removeAttribute(oe),
                t.setAttribute(re, n),
                t.setAttribute(ae, e || n),
                t.setAttribute("target", "_blank"))
              : (t.setAttribute(se, ""),
                t.setAttribute(oe, "-1"),
                t.removeAttribute(re),
                t.removeAttribute(ae));
          }
        }),
    ...
    onKeydown(t) {
      ...
      if (
        ("Tab" === t.key ? C(this.container, Jt) : P(this.container, Jt),
      ...
      (t
        ? (!n || c.indexOf(n) < 0) &&
          ...
          c.length &&
            (i === ue
              ? (d = c[0])
              : (this.lastFocus !== s && i !== de) || (d = c[c.length - 1])))
    ...
    isTopmost() {
      var t;
      return (
        (null === (t = be.getInstance()) || void 0 === t ? void 0 : t.id) ==
        this.id
      );
    }
    animate(t = null, e = "", i) {
    ...
    hideLoading(t) {
      ...
      this.isClosing()
        ...
        : (P(e, ee),
          ...
          t.state === rt.Loading &&
            (this.emit("loaded", t), (t.state = rt.Ready)));
    }
    setError(t, e) {
      if (this.isClosing()) return;
    ...
    proceedClose(t, e) {
      ...
      if (
        ...
        s &&
          (P(s, ie),
          C(s, "is-closing"),
          s.setAttribute(Kt, "true"),
          this.option("animated") && C(s, Qt),
    ...
    destroy() {
      ...
      i
        ...
        : (de && (de.remove(), (de = null)),
          ...
          P(document.documentElement, Vt),
          (() => {
            if (!et) return;
            const t = document,
              e = t.body;
            (e.classList.remove(Zt),
              e.style.setProperty(Gt, ""),
              t.documentElement.style.setProperty(Ut, ""));
          })(),
          this.emit("destroy"));
    }
    static bind(t, e, i) {
    ...
    static unbind(t, e) {
      let i,
        n = "";
      if (
        (ce(t) ? ((i = document.body), (n = t)) : ((i = t), ce(e) && (n = e)),
        !i)
      )
        return;
      ...
      (s && n && s.delete(n),
        (n && s) ||
          (be.openers.delete(i), i.removeEventListener("click", be.fromEvent)));
    }
    static destroy() {
      let t;
      for (; (t = be.getInstance()); ) t.destroy();
      for (const t of be.openers.keys())
        t.removeEventListener("click", be.fromEvent);
      be.openers = new Map();
    }
    static fromEvent(t) {
      if (t.defaultPrevented) return;
      ...
      return u && u.options.triggerEl && r.indexOf(u.options.triggerEl) > -1
        ? void 0
        : (e && (l.startIndex = r.indexOf(e)), be.fromNodes(r, l));
    }
    static fromSelector(t, e, i) {
      ...
      return (
        !!a &&
        ((o = f({}, a.get(s) || {}, o)),
        !!o && be.fromNodes(Array.from(n.querySelectorAll(s)), o))
      );
    }
    static fromNodes(t, e) {
      ...
      for (const n of t) {
        ...
        (a &&
          ...
          o &&
            ((r = o.currentSrc || o[le] || void 0),
            !r &&
              o.dataset &&
              (r = o.dataset.lazySrc || o.dataset[le] || void 0)));
        const l = {
          src: s,
          triggerEl: n,
          thumbEl: o,
    ...
    static getSlide() {
      var t;
      return (
        (null === (t = be.getInstance()) || void 0 === t
          ? void 0
          : t.getSlide()) || null
      );
    }
    ...
    static close(t = !0, ...e) {
      if (t) for (const t of ge.values()) t.close(...e);
      else {
        const t = be.getInstance();
        t && t.close(...e);
      }
