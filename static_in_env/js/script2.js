...
(function ($) {
  ...
  if (jQuery(".completed-project-slider-active .swiper").length > 0) {
    let completedProjectSlider = new Swiper(
      ".completed-project-slider-active .swiper",
      {
        loop: true,
        spaceBetween: 30,
        slidesPerView: 1,
  ...
  if (jQuery(".completed-project-slider-active-2 .swiper").length > 0) {
    let completedProjectSlider2 = new Swiper(
      ".completed-project-slider-active-2 .swiper",
      {
        loop: true,
        spaceBetween: 30,
        slidesPerView: 1,
